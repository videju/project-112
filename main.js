...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/J_-VtEXas/model.json',modelLoaded);
...
console.error(error);
        ...
        if(results[0].label == "Amazing") {
            ...
            document.getElementById("quote").innerHTML = " that was marvelous victory" ;
        }
